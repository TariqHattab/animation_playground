...
class SPainter4 extends CustomPainter {
  ...
  SPainter4(this.seeds, this.seedRaduis, this.scaleFactor, double t, double p,
      this.lineWidth)
      : this.tau = math.pi * t,
  ...
  @override
  bool shouldRepaint(SPainter4 oldDelegate) {
...
// Draw a small circle representing a seed centered at (x,y).
  ...
  bool _shouldDrawLine(double x, Size size, int i) =>
      previosPoint != null &&
      x != size.width / 2 &&
      primeNumbersList.contains(i) &&
      lineWidth != 0;
}

class SunflowerPrimaryLine extends StatefulWidget {
  @override
...
class _SunflowerState extends State<SunflowerPrimaryLine>
